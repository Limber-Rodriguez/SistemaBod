...
<head>
    ...
    <link rel="stylesheet" href="../public/css/perfil_proveedor.css">
</head>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="../../front/files/images/proveedor/perfil/<?=$_SESSION['logo'];?>" class="img-circle elevation-2" alt="User Image" 
                ...
                <nav class="mt-2">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <li class="nav-item">
                                <a href="./viperfil_proveedor.php" class="nav-link active">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Datos generales</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="./viperfil_cambiarPass.php" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="../../front/ajax/usuario.php?op=salir" class="nav-link">
